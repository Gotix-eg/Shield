...
export const ACTION_FIELDS: Record<string, Record<string, Array<{
  name: string;
  label: string;
  ...
  TRADEMARK: {
    ...
    "Application filing": [
      ...
      { name: "trademark", label: "Trademark", type: "text" },
      { name: "device", label: "Device (word / logo / combined)", type: "select", options: [
      ...
      { name: "filingSystem", label: "Filing System (National / Madrid)", type: "select", options: [{ value: "National", label: "National" }, { value: "Madrid", label: "Madrid" }] },
      ...
      { name: "representation", label: "Representation (logo / mark image)", type: "file" },
      { name: "applicationNumber", label: "Application Number", type: "text" },
      { name: "applicationDate", label: "Application Date", type: "date" },
      { name: "filingReceipt", label: "Filing Receipt Document", type: "file" },
      ...
      { name: "registrationCertificate", label: "Registration Certificate Document", type: "file" },
